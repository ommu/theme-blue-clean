			...
			<div class="container clearfix">
				<div class="box about">
					...
					<ul>
						...
						<li><a href="<?php echo Yii::app()->createUrl('page/view', array('id'=>22,'slug'=>$this->urlTitle(Yii::t('phrase', 'Tugas Pokok dan Fungsi'))))?>" title="<?php echo Yii::t('phrase', 'Tugas Pokok dan Fungsi');?>"><?php echo Yii::t('phrase', 'TUPOKSI');?></a></li>
						...
						<?php /*
						<li><a href="<?php echo Yii::app()->createUrl('page/view', array('id'=>8,'slug'=>$this->urlTitle(Yii::t('phrase', 'Peta Lokasi BPAD DIY'))))?>" title="<?php echo Yii::t('phrase', 'Peta Lokasi BPAD DIY');?>"><?php echo Yii::t('phrase', 'Peta BPAD');?></a></li>
						<li><a href="<?php echo Yii::app()->createUrl('page/view', array('id'=>9,'slug'=>$this->urlTitle(Yii::t('phrase', 'Denah Ruangan'))))?>" title="<?php echo Yii::t('phrase', 'Denah Ruangan');?>"><?php echo Yii::t('phrase', 'Denah Ruangan');?></a></li>
						*/?>
